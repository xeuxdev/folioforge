      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-12">
        ...
        <div className="bg-card border border-border p-6 rounded-2xl space-y-3 shadow-xs">
          ...
          <p className="text-sm text-muted-foreground leading-relaxed">
            FolioForge is engineered for complete data autonomy. When you host
            FolioForge, your canonical resume graph, job tailoring records,
            exported documents, and user sessions are stored exclusively in your
            dedicated PostgreSQL instance. We do not sell, track, or monetise
        ...
        <div className="space-y-8 text-foreground leading-relaxed text-sm">
          <section className="space-y-3">
            ...
            <p className="text-muted-foreground">
              When authenticating via Google OAuth 2.0, FolioForge requests
              access solely to your basic Google profile information:
            </p>
          ...
          <section className="space-y-3">
            ...
            <p className="text-muted-foreground">
              Google OAuth data is used strictly for identity verification and
              account provisioning within your local PostgreSQL `users` table.
              We do not request access to Google Drive, Gmail, or any unrelated
          ...
          <section className="space-y-3">
            ...
            <p className="text-muted-foreground">
              Sessions are maintained using stateful session tokens backed by
              PostgreSQL. Tokens are transmitted to your client browser inside
              secure HTTP-only cookies (`HttpOnly`, `SameSite=Lax`, `Secure`).
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p className="text-muted-foreground">
              You maintain total control over your records. Triggering account
              deletion purges your user profile, Google authentication metadata,
              canonical resume graphs, tailored bullet variations, and hosted
              portfolio subdomains permanently.
            </p>
          </section>
        </div>
      </main>
