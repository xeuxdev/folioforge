  ...
  return (
    <section id="philosophy" className="py-20 px-4 sm:px-6 lg:px-12 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        {/* Pillar 1 */}
        <div className="bg-stone-50 border border-stone-200 p-8 rounded-2xl space-y-4">
          <div className="flex items-center space-x-3">
            <div className="w-10 h-10 rounded-lg bg-stone-900 text-stone-50 flex items-center justify-center font-semibold text-sm">
              01
            </div>
            <h3 className="text-lg font-bold text-stone-900">Canonical Resume Graph</h3>
          </div>
          ...
          <div className="pt-2 text-xs font-mono text-stone-500 flex items-center space-x-1.5">
        ...
        <div className="bg-stone-50 border border-stone-200 p-8 rounded-2xl space-y-4">
          <div className="flex items-center space-x-3">
            ...
            <h3 className="text-lg font-bold text-stone-900">Headless React PDF Engine</h3>
          </div>
          <p className="text-sm text-stone-600 leading-relaxed">
        ...
        <div className="bg-stone-50 border border-stone-200 p-8 rounded-2xl space-y-4">
          <div className="flex items-center space-x-3">
            ...
            <h3 className="text-lg font-bold text-stone-900">Side-by-Side Diff Verification</h3>
          </div>
          <p className="text-sm text-stone-600 leading-relaxed">
