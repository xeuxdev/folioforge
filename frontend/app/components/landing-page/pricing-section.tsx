  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
        ...
        <div className="bg-card text-card-foreground p-8 rounded-2xl border border-border flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between mb-4">
              <span className="text-xs font-mono font-bold uppercase tracking-wider text-muted-foreground bg-muted px-2.5 py-1 rounded-md border border-border">
                Community Edition
              </span>
            ...
            <ul className="mt-8 space-y-3.5 text-sm text-foreground">
              ...
              <li className="flex items-center">
                <Check className="w-4 h-4 text-emerald-600 mr-3 shrink-0" />
                <span>Bring Your Own OpenAI or Ollama Key</span>
              </li>
            </ul>
          </div>
        ...
        <div className="bg-primary text-primary-foreground p-8 rounded-2xl border border-primary flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between mb-4">
              <span className="text-xs font-mono font-bold uppercase tracking-wider text-primary-foreground/80 bg-primary-foreground/10 px-2.5 py-1 rounded-md border border-primary-foreground/20">
                Managed Cloud
              </span>
              <Server className="w-5 h-5 text-primary-foreground" />
            </div>
            <h3 className="text-2xl font-bold text-primary-foreground">Managed Pro Cloud</h3>
            ...
            <ul className="mt-8 space-y-3.5 text-sm text-primary-foreground/90">
              ...
              <li className="flex items-center">
                <Check className="w-4 h-4 text-emerald-400 mr-3 shrink-0" />
                <span>Custom Subdomain (yourname.folioforge.dev)</span>
              </li>
              <li className="flex items-center">
                <Check className="w-4 h-4 text-emerald-400 mr-3 shrink-0" />
          ...
          <div className="mt-10">
            <a
              ...
              className={buttonVariants({
                variant: "secondary",
                className: "w-full py-6 text-sm font-semibold cursor-pointer rounded-xl",
              })}
            >
